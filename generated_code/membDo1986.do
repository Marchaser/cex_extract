...
infix
  ...
  str SCHLTYPE 228-228
  str SCHL_YPE 229-229
  str SCHMLSHR 230-230
  str SCHM_SHR 231-231
  ...
  str SSNORM 278-278
  str SSNORM_ 279-279
using ${SRC}\1986\09113-0002-Data.txt;
save memb\memb1986q1, replace;
...
infix
  ...
  str SSNORM 278-278
  str SSNORM_ 279-279
using ${SRC}\1986\09113-0006-Data.txt;
save memb\memb1986q2, replace;
...
infix
  ...
  str SSNORM 278-278
  str SSNORM_ 279-279
using ${SRC}\1986\09113-0010-Data.txt;
save memb\memb1986q3, replace;
...
infix
  ...
  str SSNORM 278-278
  str SSNORM_ 279-279
using ${SRC}\1986\09113-0014-Data.txt;
save memb\memb1986q4, replace;
...
infix
  ...
  str SSNORM 278-278
  str SSNORM_ 279-279
using ${SRC}\1986\09113-0018-Data.txt;
save memb\memb1986q5, replace;
